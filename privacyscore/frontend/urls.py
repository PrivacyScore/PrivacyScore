...
urlpatterns = [
    ...
    url(r'^list/(?P<scan_list_id>\d+)/$', views.view_scan_list, {'format': 'html'},
        name='view_scan_list'),
    url(r'^list/(?P<scan_list_id>\d+)/result\.json$', views.view_scan_list, {'format': 'json'},
        name='view_scan_list_json'),
    url(r'^list/(?P<scan_list_id>\d+)/result\.csv$', views.view_scan_list, {'format': 'csv'},
        name='view_scan_list_csv'),
    ...
    url(r'^list/(?P<scan_list_id>\w+)\.csv$', views.scan_list_csv, name='scan_list_csv'),
    ...
    url(r'^site/(?P<site_id>\d+)/json/$', views.site_result_json, name='site_result_json'),
