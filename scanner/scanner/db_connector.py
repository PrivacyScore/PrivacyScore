            ...
            for url in url_List:
                ...
                for start_time, site_url in cur.execute(
                    ...
                    try:
                        ...
                        print "Error during saving geoip data to DB: "+self.GetException()
                        scantosave["geoip"] = "failed: "+self.GetException()
                    ...
                    try:
                        ...
                        print "Error during saving testssl data to DB: "+self.GetException()
                        scantosave["testssl"] = "failed: "+self.GetException()
                    ...
                    try:
                        ...
                        print "Error during saving testsslmx data to DB: "+self.GetException()
                        scantosave["testsslmx"] = "failed: "+self.GetException()
                    ...
                    if(testssl_available):
                        ...
                        match = self.check_testssl(header_res, 'hsts')
                        if match:
                        ...
                        if result['status'] != 'FAIL':
                            ...
                            match = self.check_testssl(header_res, 'hsts_time')
                            if match:
                                severity = match['severity']
                                finding  = match['finding']
                        ...
                        if result['status'] != 'FAIL':
                            ...
                            match = self.check_testssl(header_res, 'hsts_preload')
                            if match:
                                severity = match['severity']
                                finding  = match['finding']
                                result['status'] = 'OK' # hsts header is present!
